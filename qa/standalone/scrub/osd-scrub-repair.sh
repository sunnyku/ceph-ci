...
function TEST_auto_repair_bluestore_basic() {
    ...
    CEPH_ARGS='' ceph tell $pgid deep_scrub
    CEPH_ARGS='' ceph tell $pgid scrub
...
function TEST_periodic_scrub_replicated() {
    ...
    CEPH_ARGS='' ceph tell $pg scrub || return 1
...
function TEST_scrub_warning() {
    ...
    do
      ...
      CEPH_ARGS='' ceph tell ${i}.0 scrub $(expr ${overdue_seconds} + ${i}00) || return 1
    done
    ...
    do
      ...
      CEPH_ARGS='' ceph tell ${i}.0 deep_scrub $(expr ${overdue_seconds} + ${i}00) || return 1
    done
    flush_pg_stats
...
function TEST_request_scrub_priority() {
    ...
    do
        ...
        # Fake a schedule scrub
        CEPH_ARGS='' ceph tell $opg scrub $opg || return 1
    done
