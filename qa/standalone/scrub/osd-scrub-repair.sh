    ...
    jq "$jqfilter" << EOF | python -c "$sortkeys" | sed -e "$sedfilter" > $dir/checkcsjson
{
  "inconsistents": [
    ...
    },
    {
      "shards": [
        {
          "object_info": "3:ffdb2004:::ROBJ9:head(102'63 client.4433.0:1 dirty|omap|data_digest s 1 uv 67 dd 2b63260d alloc_hint [0 0 0] extents [0~1])",
          "size": 1,
          "errors": [],
          "osd": 0,
          "primary": false
      ...
      "selected_object_info": "3:ffdb2004:::ROBJ9:head(102'63 client.4433.0:1 dirty|omap|data_digest s 1 uv 67 dd 2b63260d alloc_hint [0 0 0] extents [0~1])",
      "union_shard_errors": [
         "obj_size_oi_mismatch"
      ],
      "errors": [
  ...
  "inconsistents": [
    ...
    },
    {
      "shards": [
        ...
        {
          "object_info": "3:ffdb2004:::ROBJ9:head(122'64 client.4532.0:1 dirty|omap|data_digest s 3 uv 68 dd 1f26fb26 alloc_hint [0 0 0] extents [0~3])",
          "data_digest": "0x1f26fb26",
          "omap_digest": "0x2eecc539",
          "size": 3,
          "errors": [],
      ...
      "selected_object_info": "3:ffdb2004:::ROBJ9:head(122'64 client.4532.0:1 dirty|omap|data_digest s 3 uv 68 dd 1f26fb26 alloc_hint [0 0 0] extents [0~3])",
      "union_shard_errors": [
        "obj_size_oi_mismatch"
      ],
      "errors": [
