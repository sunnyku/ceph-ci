...
class CephCluster(object):
    ...
    def __init__(self, ctx, cluster):
        ...
        log.info("CephCluster: cluster={0}".format(cluster))
...
class MDSCluster(CephCluster):
    ...
    def __init__(self, ctx, cluster):
        ...
        log.info("MDSCluster: cluster={0}".format(cluster))
...
class Filesystem(MDSCluster):
    ...
    def __init__(self, ctx, cluster='ceph', fscid=None, name=None, create=False,
        ...
        log.info("Filesystem: cluster={0} ctx.cluster={1}".format(cluster, ctx.cluster))
        ...
        if cluster == 'ceph':
            ...
            _roles = "{0}.client.{1}".format(cluster, self.client_id)
