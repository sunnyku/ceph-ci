...
class TestMirroringCommands(CephFSTestCase):
    ...
    def _add_peer(self, fs_name, peer_spec):
        self.fs.mon_manager.raw_cluster_cmd("fs", "mirror", "peer_add", fs_name, peer_spec)
    ...
    def test_mirroring_peer_commands(self):
        ...
        self._enable_mirroring(self.fs.name)
        self._add_peer(self.fs.name, "client.site-b@site-b")
        self._add_peer(self.fs.name, "client.site-c@site-c")
        self._verify_mirroring(self.fs.name, "enabled")
