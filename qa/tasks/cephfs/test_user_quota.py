...
class TestUserQuota(CephFSTestCase):
    ...
    def test_setfattr_and_getfattr(self):
        ...
        # Debug
        self.mount_a.run_shell(["getfattr", "-n", "ceph.user_quota.max_bytes@root", "./subdir"])
        self.mount_a.run_shell(["getfattr", "-n", "ceph.group_quota.max_bytes@root", "./subdir"])
    ...
    def test_write_exceed_user_quota(self):
        ...
        with self.assertRaises(CommandFailedError):
            self.mount_a.write_n_mb("subdir_data/file1", 40)
    ...
    def test_user_write_with_multiple_parent(self):
        ...
        #Debug
        self.mount_a.run_shell(["getfattr", "-n", "ceph.user_quota.max_bytes@root", "./subdir"])
        self.mount_a.run_shell(["getfattr", "-n", "ceph.user_quota.max_bytes@root", "./subdir/subdir1"])
        self.mount_a.run_shell(["getfattr", "-n", "ceph.user_quota.max_bytes@root", "./subdir/subdir1/subdir2"])
    ...
    def test_group_write_with_multiple_parent(self):
        ...
        #Debug
        self.mount_a.run_shell(["getfattr", "-n", "ceph.group_quota.max_bytes@root", "./subdir"])
        self.mount_a.run_shell(["getfattr", "-n", "ceph.group_quota.max_bytes@root", "./subdir/subdir1"])
        self.mount_a.run_shell(["getfattr", "-n", "ceph.group_quota.max_bytes@root", "./subdir/subdir1/subdir2"])
