...
protected:
  ...
  bool is_user_quota_files_exceeded(Inode *in, const UserPerm& perms, bool flag);
  ...
  bool check_group_quota_condition(Inode *in, gid_t gid,
      std::function<bool (Inode &)> test);
  bool is_group_quota_files_exceeded(Inode *in, const UserPerm& perms, bool flag);
...
#define VXATTR_RSTAT 0x1
  ...
  size_t _vxattrcb_user_quota_max_files(Inode *in, char *val, size_t size, const char *name);
  ...
  size_t _vxattrcb_group_quota_max_files(Inode *in, char *val, size_t size, const char *name);
  ...
  size_t _vxattrcb_dir_user_rfiles(Inode *in, char *val, size_t size, const char *name);
  size_t _vxattrcb_dir_user_rsubdirs(Inode *in, char *val, size_t size, const char *name);
  size_t _vxattrcb_dir_user_rbytes(Inode *in, char *val, size_t size, const char *name);
  size_t _vxattrcb_dir_group_rfiles(Inode *in, char *val, size_t size, const char *name);
  size_t _vxattrcb_dir_group_rsubdirs(Inode *in, char *val, size_t size, const char *name);
