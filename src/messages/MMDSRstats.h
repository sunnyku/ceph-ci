...
class MMDSRstats : public SafeMessage {
...
protected:
  MMDSRstats() : SafeMessage(MSG_MDS_RSTATS, HEAD_VERSION, COMPAT_VERSION) {}
  MMDSRstats(unsigned e, const utime_t& f, const utime_t& a) :
    SafeMessage(MSG_MDS_RSTATS, HEAD_VERSION, COMPAT_VERSION),
