...
--verbose   Increase the verbosity level
	...
	warning = 'See "ceph-volume-zfs --help" for full list of options.' if warning else ''
    ...
    def stat_ceph_conf(self):
        try:
            ...
            return terminal.red("stat_ceph_conf: Error")
    ...
    def main(self, argv):
       ...
       # these need to be available for the help, which gets parsed super
        ...
        logger.info("Running command: ceph-volume-zfs %s %s", " ".join(main_args), " ".join(subcommand_args))
