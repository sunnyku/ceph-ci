...
struct HeartbeatStamps : public RefCountedObject {
  ...
  boost::optional<ceph::signedspan> peer_clock_delta_lb;

  /// upper bound on peer clock - local clock
  boost::optional<ceph::signedspan> peer_clock_delta_ub;
  ...
  void sent_ping(boost::optional<ceph::signedspan> *delta_ub) {
    std::lock_guard l(lock);
  ...
  void got_ping(epoch_t this_up_from,
		...
		boost::optional<ceph::signedspan> delta_ub,
