...
public:
  ...
  void dump(TextTable *tbl) {
    ...
    *tbl << ""
	 ...
	 << si_t(pgmap.get_osd_sum().kb_used_data << 10)
	 << si_t(pgmap.get_osd_sum().kb_used_omap << 10)
	 << si_t(pgmap.get_osd_sum().kb_used_meta << 10)
...
protected:
  ...
  void dump_item(const CrushTreeDumper::Item &qi,
    ...
    *tbl << qi.id
	 ...
	 << si_t(kb << 10)
	 << si_t(kb_used << 10)
	 << si_t(kb_used_data << 10)
	 << si_t(kb_used_omap << 10)
	 << si_t(kb_used_meta << 10)
	 << si_t(kb_avail << 10)
	 << lowprecision_t(util)
	 << lowprecision_t(var);
