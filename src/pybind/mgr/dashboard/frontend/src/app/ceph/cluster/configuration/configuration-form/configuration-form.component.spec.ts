...
describe('ConfigurationFormComponent', () => {
  ...
  describe('getType', () => {
    ...
    it('should return size_t type', () => {
      ...
      expect(ret.inputType).toBe('number');
      expect(ret.humanReadable).toBe('Integer value (size)');
    });
    ...
    it('should return secs type', () => {
      ...
      expect(ret.inputType).toBe('number');
      expect(ret.humanReadable).toBe('Integer value (secs)');
    });
  ...
  describe('getPatternHelpText', () => {
    it('should return a help text for type uint64_t', () => {
      const ret = component.getPatternHelpText('uint64_t');
      expect(ret).toBeTruthy();
      expect(ret).toBe('The entered value needs to be a number.');
    });

    it('should return a help text for type int64_t', () => {
      const ret = component.getPatternHelpText('int64_t');
      expect(ret).toBeTruthy();
      expect(ret).toBe('The entered value needs to be a number.');
    });

    it('should return a help text for type size_t', () => {
      const ret = component.getPatternHelpText('size_t');
      expect(ret).toBeTruthy();
      expect(ret).toBe('The entered value needs to be a number.');
    });

    it('should return a help text for type secs', () => {
      const ret = component.getPatternHelpText('secs');
      expect(ret).toBeTruthy();
      expect(ret).toBe('The entered value needs to be a number.');
    });

    it('should return a help text for type double', () => {
      const ret = component.getPatternHelpText('double');
      expect(ret).toBeTruthy();
      expect(ret).toBe('The entered value needs to be a number or decimal.');
    });

    it('should return a help text for type entity_addr_t', () => {
      const ret = component.getPatternHelpText('entity_addr_t');
      expect(ret).toBeTruthy();
      expect(ret).toBe('The entered value needs to be a valid IP address.');
    });

    it('should return a help text for type uuid_d', () => {
      const ret = component.getPatternHelpText('uuid_d');
      expect(ret).toBeTruthy();
      expect(ret).toBe(
    ...
    it('should return nothing for unknown type', () => {
      const ret = component.getPatternHelpText('unknown');
