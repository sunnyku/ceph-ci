...
#        return result
    ...
    def add_mds(self, spec):
        ...
        return self._get_daemons('mds').then(lambda ds: self._add_mds(ds, spec))

    def _add_mds(self, daemons, spec):
        # type: (List[orchestrator.DaemonDescription], orchestrator.ServiceSpec) -> AsyncCompletion
        args = []
        num_added = 0
