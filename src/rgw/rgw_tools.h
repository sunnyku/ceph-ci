...
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      ...
                      optional_yield y, const Span& parent_span = NULL);
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectReadOperation *op, bufferlist* pbl,
                      int flags, optional_yield y, const Span& parent_span = NULL);
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectWriteOperation *op, optional_yield y, const Span& parent_span = NULL);
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectWriteOperation *op, int flags, optional_yield y, const Span& parent_span = NULL);
