...
namespace system {
template<>
struct is_error_code_enum<::rgw_errc::rgw_errc_t> {
...
namespace rgw_errc {
//  explicit conversion:
inline boost::system::error_code make_error_code(rgw_errc_t e) noexcept {
  return { e, rgw_category() };
}

// implicit conversion:
inline boost::system::error_condition make_error_condition(rgw_errc_t e)
  noexcept {
  return { e, rgw_category() };
}
}
