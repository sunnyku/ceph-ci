...
bool OSDMonitor::preprocess_command(MonOpRequestRef op)
{
  ...
  if (prefix == "osd stat") {
    ...
    if (f) {
      ...
      tbl.define_column("NETWORK", TextTable::LEFT, TextTable::LEFT);
      tbl.define_column("STORAGE", TextTable::LEFT, TextTable::LEFT);
      tbl.define_column("AFFINITY", TextTable::LEFT, TextTable::LEFT);
