...
void Monitor::handle_command(MonOpRequestRef op)
{
  ...
  // compat kludge for legacy clients trying to tell commands that are new.  see
  // PreOctopusTellMonCommands.h.  we need to handle both (1) pre-octopus clients
  // and (2) octopus clients but a pre-octopus mix of mons.
