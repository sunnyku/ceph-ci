...
(mintor commands) are detailed below.
...
and cluster name tuple. To add a mirror peer::
  ...
  $ ceph fs mirror peer_add <fsname> <client@cluster>
...
`ceph fs get` commands as below::
  ...
  ...
  ...
  [peers={uuid=e3739ebf-dbce-460a-bf9c-c66b57697c9a, remote_cluster={client_name=client.site-a, cluster_name=site-a}}]
